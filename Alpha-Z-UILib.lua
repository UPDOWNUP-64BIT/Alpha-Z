...
if game.CoreGui:FindFirstChild('AlphaZUIlib') then
    game.CoreGui:FindFirstChild('AlphaZUIlib'):Destroy()
    destroyed = true
end
...
local AlphaZUIlib = Instance.new("ScreenGui")

AlphaZUIlib.Name = "AlphaZUIlib"

protect_gui(AlphaZUIlib)
...
function library:Keybind(key)
    ...
    keybindConnection = uis.InputBegan:Connect(function(input, gp)
        if not gp and input.KeyCode == Enum.KeyCode[key] then
            AlphaZUIlib.Enabled = not AlphaZUIlib.Enabled
        end
    end)
end
...
function library:Window(name) 
    ...
    UiWindow.Parent = AlphaZUIlib
    UiWindow.BackgroundColor3 = Color3.fromRGB(31, 121, 239)
    UiWindow.BorderColor3 = Color3.fromRGB(31, 121, 239)
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        ToggleRGB.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
        ...
        ClosePicker.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
